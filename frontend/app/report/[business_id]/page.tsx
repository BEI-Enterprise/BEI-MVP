          ...
          <>
            <div style={{ padding: '28px', border: '1px solid #2a3a1a', borderRadius: '10px', backgroundColor: '#080f04', marginBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap' as const, gap: '16px' }}>
              <div>
                ...
                <div style={{ fontSize: '14px', color: '#666' }}>Upgrade to access full constraint network, opportunity map and deployment engine</div>
              </div>
          ...
          <>
            {secondary.length > 0 && (
              <div style={{ ...cardStyle, marginBottom: '24px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '12px' }}>
                  {secondary.map((c: any) => (
                    <div key={c.key} style={{ padding: '16px', backgroundColor: '#080808', borderRadius: '6px', border: '1px solid #1a1a1a' }}>
            ...
            {primary?.opportunity && (
              <div style={{ ...cardStyle, marginBottom: '24px' }}>
                <div style={{ fontSize: '11px', color: '#555', letterSpacing: '0.15em', textTransform: 'uppercase' as const, marginBottom: '14px', fontWeight: '600' }}>Opportunity Map</div>
                <div style={{ fontSize: '15px', color: '#ccc', lineHeight: '1.75', marginBottom: '16px' }}>{primary.opportunity.explanation}</div>
              </div>
            )}
